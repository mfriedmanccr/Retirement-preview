        ...
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-10 relative">
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              ...
              {/* NEW: Professional cost message (keeps same visual style) */}
              <p className="mt-4 text-base md:text-lg text-slate-400 max-w-2xl">
                Hiring a professional for this level of retirement planning commonly costs{" "}
                <span className="text-slate-200 font-semibold">several thousand dollars</span>.
                DIY RLP gives you that decision-grade modeling — with unlimited scenario testing — at a fraction of the cost.
              </p>
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        {/* NEW: Professional cost message (keeps prior feel) */}
        <p className="mt-3 text-slate-400 max-w-3xl">
          Professional retirement planning at this depth often costs{" "}
          <span className="text-slate-200 font-semibold">several thousand dollars</span>.
          DIY RLP gives you the same class of decision-grade modeling with unlimited “what-if” testing — in Excel.
        </p>
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        {/* NEW: Professional cost message here too (lightweight) */}
        <p className="mt-3 text-slate-400 max-w-3xl">
          Comparable professional planning commonly costs{" "}
          <span className="text-slate-200 font-semibold">several thousand dollars</span>.
          DIY RLP gives you unlimited scenarios and full transparency in Excel — for $150.
        </p>
      </div>
...
function FAQ() {
  const items = [
    ...
    {
      q: "How does this compare to hiring a professional?",
      a: "Hiring a professional for this level of retirement planning commonly costs several thousand dollars. DIY RLP gives you the same class of modeling logic with unlimited scenario testing — in Excel — for $150.",
    },
  ];
